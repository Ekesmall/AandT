...
class Loader {
    ...
    public static function init() {
        ...
        // Amelia Integration
        // CRITICAL: EnrollmentGuard now wraps shortcode instead of blocking submission
        Amelia\EnrollmentGuard::init();
        
        // NEW: Validate recurring session count AFTER booking is created
        Amelia\RecurringSessionValidator::init();
        
        // Track bookings and complete lessons
    ...
    public static function load_frontend_assets() {
        ...
        // Check if we're on a TutorLMS page OR if Amelia is active
        if ( ! function_exists( 'tutor' ) && ! defined( 'AMELIA_VERSION' ) ) {
            return;
        }
